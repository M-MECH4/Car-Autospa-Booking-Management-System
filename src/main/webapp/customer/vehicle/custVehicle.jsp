...
<head>
    <meta charset="UTF-8">
    <title>Add Vehicle | X-PERT Detailing</title>
   ...
   <jsp:include page="/sidebar.jsp" />
    <main class="xp-main-content">
       ...
       <div class="vehicle-top">
            <div>
                <h1>Add Vehicle</h1>
                <p>Register a vehicle before creating a detailing booking.</p>
            </div>
        ...
        <div class="booking-table-card" style="max-width:650px; padding:28px;">
            <form action="${pageContext.request.contextPath}/custVehicleController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="vehicleplatenum" placeholder="Example: ABC1234" required>
                </div>

                <div class="form-group">
                    <label>Brand</label>
                    <input type="text" class="form-control" name="vehiclebrand" placeholder="Example: Perodua" required>
                </div>

                <div class="form-group">
                    <label>Model</label>
                    <input type="text" class="form-control" name="vehiclemodel" placeholder="Example: Myvi" required>
                </div>
